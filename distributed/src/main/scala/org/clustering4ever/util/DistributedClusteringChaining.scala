...
import org.clustering4ever.chaining.ClusteringChainingLocal
import org.clustering4ever.clusteringtraits.{ClusteringAlgorithmLocal, ClusteringInformationsLocal, ClusteringModelLocal, DataExplorator}
...
case class DistributedClusteringChaining[
    ...
    final def runAlgorithms(defaultParallelism: Int, argsModels: ClusteringAlgorithmLocal[V, _ <: ClusteringModelLocal[V]]*): Self[V, Vecto] = {
        ...
        new DistributedClusteringChaining(sc, dataFinal, chainableIDFinal, currentVectorizationFinal, clusteringInformationsFinal) {
            ...
            override protected[clustering4ever] val fusionChainableSecurity = clusteringChainingLocalFinal.fusionChainableSecurity
        }
    }
    /**
     *
