...
// 	val clusteringInformations: immutable.HashSet[(GlobalClusteringRunNumber, Vectorization[O, V], ClusteringArgs[V], ClusteringModelCz[ID, O, V, Cz, Collection, ClusteringArgs[V]])]
