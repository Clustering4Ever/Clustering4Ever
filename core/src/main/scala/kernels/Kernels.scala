...
import org.clustering4ever.vectors.{GVector, GBinaryVector, GScalarVector, GMixedVector, ScalarVector}
/**
 *
 */
 ...
 *
 */
case class SigmoidKernel[V <: Seq[Double]](val kernelArgs: KernelArgsSigmoid) extends Kernel[ScalarVector[V], KernelArgsSigmoid] {
	/**
	 *
	 */
