...
// import _root_.org.clustering4ever.math.distances.binary.{Hamming, MeanMahanttan, PatternDifference, ShapeDifference, SizeDifference, Vari}
// import _root_.org.clustering4ever.math.distances.scalar.{Cosine, Euclidean, Minkowski}
