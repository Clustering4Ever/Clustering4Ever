...
// 	  * @return The Hamming distance between dot1 and dot2
// 	  */
// 	def d[@specialized(Int, Long) ID, O, Cz[X, Y, Z <: GVector] <: Clusterizable[X, Y, Z, Cz[X, Y, Z]]](dot1: Cz[ID, O, BinaryVector[V]], dot2: Cz[ID, O, BinaryVector[V]]): Double = hamming(dot1.workingVector.vector, dot2.workingVector.vector)
// }