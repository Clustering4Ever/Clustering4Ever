...
import _root_.scala.collection.{GenSeq, immutable, mutable}
...
trait ClusteringModelLocal[V <: GVector[V]] extends ClusteringModel {
	 ...
	 */
	protected[clustering4ever] def obtainClustering[O, Cz[Y, Z <: GVector[Z]] <: Clusterizable[Y, Z, Cz], GS[X] <: GenSeq[X]](data: GS[Cz[O, V]]): GS[Cz[O, V]]
	/**
	 * Obtain clusterIDs corresponding to the given dataset
	 */
	protected[clustering4ever] final def obtainClusteringIDs[O, Cz[Y, Z <: GVector[Z]] <: Clusterizable[Y, Z, Cz], GS[X] <: GenSeq[X]](data: GS[Cz[O, V]]): GS[ClusterID] = {
