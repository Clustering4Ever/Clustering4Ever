...
object KMeans {
	...
	def run[
		...
		)(implicit ct: ClassTag[V[Double]], ct2: ClassTag[Cz[ID, O, V[Double]]]): KCentersModel[ID, O, V[Double], Cz[ID, O, V[Double]], D] = {
...
object KModes {
	...
	)(implicit ct1: ClassTag[V[Int]], ct2: ClassTag[Cz[ID, O, V[Int]]]): KCentersModel[ID, O, V[Int], Cz[ID, O, V[Int]], D] = {
