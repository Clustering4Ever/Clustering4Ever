 ...
 * @author Beck Gaël
 */
import org.clustering4ever.clusteringtraits.{ClusteringBasicStatsKeeper, ClustersAnalysis}
...
import org.clustering4ever.util.{ClusterBasicOperations, SumVectors}

import scala.collection.{GenMap, GenSeq, immutable}
