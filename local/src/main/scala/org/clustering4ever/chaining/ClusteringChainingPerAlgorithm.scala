...
import org.clustering4ever.qualitymeasures.MultiExternalIndicesLocal
import org.clustering4ever.roottraits._
import org.clustering4ever.util.SortingTools

import _root_.scala.collection.{GenSeq, mutable, parallel}
...
trait ChainingOneAlgorithm[
    ...
    final val clusteringIDsResults: parallel.ParSeq[GS[ClusterID]] = {
        ...
        if(vectorizations.size == 1) {   
            ...
            vectorizations.zipWithIndex.par.flatMap { case (vecto, vectoIdx) =>
